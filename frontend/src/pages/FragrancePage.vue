<template>
  <div class="category-page">
    <div class="category-hero">
      <div class="category-hero__bg" style="background: linear-gradient(160deg, #6b5a3e 0%, #3d2e1a 100%)"></div>
      <div class="category-hero__content">
        <p class="hero-en">FRAGRANCE</p>
        <h1 class="hero-title">향수</h1>
      </div>
    </div>
    <div class="container">
...
onMounted(async () => {
  try { const res = await productAPI.getByCategory(3); products.value = res.data; } catch(e) {}
});
</script>
<style scoped>
